...
public class AddonRecipeManager {
    ...
    public static void addRecipes() {
        ...
        //Hardcoded Recipes
        GameRegistry.addRecipe(new ShapedOreRecipe(AddonComponent.liquidNitrogen, true, "III", "IBI", "III", 'I', Ice, 'B', waterBucket));
        GameRegistry.addRecipe(new ShapedOreRecipe(AddonComponent.rubberHose, true, "WWW", "G G", "WWW", 'Q', Quartz, 'W', Wool, 'G', glass));
        GameRegistry.addSmelting(Block.coalBlock.blockID, AddonComponent.rawCarbon, 5f);
        GameRegistry.addRecipe(new ShapedOreRecipe(ItemComponent.carbonMyofiber, true, "RRR", "RRR", "RRR", 'R', AddonComponent.rawCarbon));
