...
public class TempAxeModule extends PowerModuleBase implements IBlockBreakingModule, IToggleableModule {
    public static final String MODULE_AXE = "Temp Axe";
    ...
    public TempAxeModule(List<IModularItem> validItems) {
        super(validItems);
    ...
    public String getDescription() {
        return "Temp Axes are mostly for chopping trees.";
    }
